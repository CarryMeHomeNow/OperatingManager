...
public class Placeholder {
    ...
    public static void main(String[] args) {
        ...
        params.put("text", "\"items\": [\n" +
                "{\n" +
                "\"type\": \"commodity\",\n" +
                "\"imgUrl\": \"https://\",\n" +
                "\"titleContent\": \"电视1\",\n" +
                "\"currentPrice\": \"888\",\n" +
                "\"originalPrice\": \"888889\",\n" +
                "\"actionParams\": {\n" +
                "\"actionType\": \"jump_native\",\n" +
                "\"actionUrl\": \"detail_commodity\",\n" +
                "\"commodityId\": \"1234556s\"\n" +
                "},\n" +
                "\"commodityType\": \"list\"\n" +
                "}]");

        System.out.println(replace("你的用户名是${user},密码是${password}。系统版本${system-${版本}}",params,"${","}",false));
        System.out.println(replace("表达对一个人无比的崇拜怎么表述最好？答：“愿闻其${详}”，测试${text}",params,"${","}",false));
    }
