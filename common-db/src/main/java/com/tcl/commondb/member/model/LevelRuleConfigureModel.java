...
@Table(name="member_level_rule_configure")
@Entity
public class LevelRuleConfigureModel {

    @Id
    @GeneratedValue
    private Integer id;

    @Column(name = "name",columnDefinition = "varchar(100) DEFAULT NULL COMMENT '创建人'")
    private String name;

    @Column(name = "content",columnDefinition = "text DEFAULT NULL COMMENT '等级规则'")
    private String content;

    @Column(name = "content_format",columnDefinition = "text DEFAULT NULL COMMENT '等级规则转换JSON'")
